...
namespace OES.Blazor.Components.Common.MCQComponents
{
    public partial class MCQQuestion
    {
        [Parameter] public MarkupString QuestionBody { get; set; }
        [Parameter] public MarkupString QuestionInstructions { get; set; } // TODO: Added for potential future use
