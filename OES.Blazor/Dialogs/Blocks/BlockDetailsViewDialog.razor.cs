...
namespace OES.Blazor.Dialogs.Blocks
{
    public partial class BlockDetailsViewDialog
    {
        ...
        {
            var blockId = await SessionStorage.GetValue<long>(MiscConstants.PerformViewBtnClick);
