...
{
    public partial class SecurityConfigurationsTemplatesDialog
    {
        ...
        private void GetSecurityConfigById(long templateId)
        {
        ...
        private async Task DeleteSecurityConfigurationTemplateAsync(object templateId)
        {
            var parameters = new DialogParameters<GenericDialog>
        {
            ...
            if (!result.Canceled)
            {
                ...
                var response = await BlazSecurityConfigurationService.DeleteSecurityConfigurationsTemplateAsync(parsedId);
