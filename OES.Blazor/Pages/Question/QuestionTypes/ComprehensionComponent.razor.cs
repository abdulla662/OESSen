...
{
    public partial class ComprehensionComponent
    {
        ...
        public async Task OnSubmitAsync()
        {
            ...
            Model.ModelAnswer = Resource.NoModelAnswerAvailable;
        ...
        private async Task LoadInstructionTemplate()
        {
            ...
            {
                InstructionsEditorParams.InitialContent = selectedTemplate.Content;
