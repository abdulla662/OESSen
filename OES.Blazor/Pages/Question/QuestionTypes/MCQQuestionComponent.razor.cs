...
{
    public partial class MCQQuestionComponent
    {
        ...
        private List<TextEditorParams> Choices { get; set; } = [];
        ...
        private async Task<(bool IsValid, string Message)> ValidateFormAsync()
        {
            ...
            if (isLanguageInvalid || QuestionBodyParams.ErrorShown || Choices.Exists(c => c.ErrorShown))
            {
        ...
        public async Task OnSubmitAsync()
        {
            ...
            Model.ModelAnswer = correctChoice is not null ? await correctChoice.GetTextEditorContentAsync() : string.Empty;
