...
{
    public class GetPaperMetadataResponseDto
    {
        ...
        public long OutputFormsCount { get; init; }
        ...
        public ScoreSchemaType ScoreSchemaType { get; set; }
        ...
        public List<long> AdaptiveCategoryExecutionOrder { get; set; } = [];
