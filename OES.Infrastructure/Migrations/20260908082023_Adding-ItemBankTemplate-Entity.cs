...
{
    /// <inheritdoc />
    public partial class AddingItemBankTemplateEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ItemBankTemplates",
                columns: table => new
                {
                    ...
                    Data = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsFromItmBankAI = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemBankTemplates", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
        }
